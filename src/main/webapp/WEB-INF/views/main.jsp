		...
		<div class="content_area">
			...
			<div class="slide_div_wrap">
				<div class="slide_div">
					<div>
						<a>
							<img src="../resources/img/skills3.jpg">
						</a>
					</div>
					<div>
						<a>
							<img src="../resources/img/skills2.jpg">
						</a>
					</div>
					<div>
						<a>
							<img src="../resources/img/skills.jpg">
						</a>
					</div>				
				</div>	
			</div>
		...
		<div class="footer">
			<div class="footer_container">
				...
				<div class="footer_right">
					...
					<br>
					<br>
					COPYRIGHT(C) <strong>ooo.blws.com</strong>	ALL RIGHTS RESERVED.
				</div>
				<div class="clearfix"></div>
			</div>
		</div> <!-- class="footer" -->		
